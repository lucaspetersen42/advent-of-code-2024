import math
from day_3.part_1 import load_input


def unjumble_mess(corrupted_memory: str) -> int:
    # I commit to a regex-free solution, for reasons of Alan Pallu.
    statement_allow_memory = ""
    corrupted_memory_statement_pieces = corrupted_memory.split("do()")

    for piece in corrupted_memory_statement_pieces:
        statement_allow_memory += piece.split("don't()")[0]

    corrupted_memory_pieces = statement_allow_memory.split("mul(")
